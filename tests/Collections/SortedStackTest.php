...
use Smpl\Collections\SortedStack;
 ...
 * @group sorted
 */
class SortedStackTest extends TestCase
{
    /**
     * @var int[]
     */
    ...
    /**
     * @var \Smpl\Collections\SortedStack 
     */
    private SortedStack $queue;

    public function setUp(): void
    {
        $this->queue = new SortedStack($this->elements);
    }
    ...
    public function collectionCreatesFromIterables(): array
    {
        return [
            ...
            'From SortedStack'   => [new Collection([6, 5, 4, 3, 2, 1, 0]), 7],
        ];
    }
    ...
    {
        $collection = new SortedStack($elements);
    ...
    {
        $collection = SortedStack::of(...$elements);
    ...
    public function collectionContainsComparatorProvider(): array
    {
        ...
        $creator               = function (Comparator $comparator): SortedStack {
            return new SortedStack($this->elements, $comparator);
        };
     ...
     */
    public function knowsWhatItContainsWithComparator(int|string $value, bool $result, SortedStack $collection): void
    {
     ...
     */
    public function knowsWhatItContainsAllWithComparator(array $value, bool $result, SortedStack $collection): void
    {
     ...
     */
    public function countsMatchingElementsWithComparator(int|string $value, int $result, SortedStack $collection): void
    {
    ...
    {
        self::assertTrue((new SortedStack())->isEmpty());

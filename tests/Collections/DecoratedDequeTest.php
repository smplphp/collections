...
use Smpl\Collections\Tests\Fixtures\DecoratedDeque;
 ...
 * @group decorated
 */
class DecoratedDequeTest extends TestCase
{
    /**
     * @var int[]
     */
    ...
    /**
     * @var \Smpl\Collections\Tests\Fixtures\DecoratedDeque 
     */
    private DecoratedDeque $queue;

    public function setUp(): void
    {
        $this->queue = new DecoratedDeque($this->elements);
    }
    ...
    public function queueCreatesFromIterables(): array
    {
        return [
            ...
            'From DecoratedDeque'         => [new DecoratedDeque([0, 1, 2, 3, 4, 5, 6]), 7],
        ];
    }
    ...
    {
        $collection = new DecoratedDeque($elements);
    ...
    {
        $collection = DecoratedDeque::of(...$elements);
    ...
    public function queueContainsComparatorProvider(): array
    {
        ...
        $creator               = function (Comparator $comparator): DecoratedDeque {
            return new DecoratedDeque($this->elements, $comparator);
        };
     ...
     */
    public function knowsWhatItContainsWithComparator(int|string $value, bool $result, DecoratedDeque $collection): void
    {
     ...
     */
    public function knowsWhatItContainsAllWithComparator(array $value, bool $result, DecoratedDeque $collection): void
    {
     ...
     */
    public function countsMatchingElementsWithComparator(int|string $value, int $result, DecoratedDeque $collection): void
    {
    ...
    {
        self::assertTrue((new DecoratedDeque())->isEmpty());

...
use Smpl\Collections\Tests\Fixtures\DecoratedSequence;
 ...
 * @group decorated
 */
class DecoratedSequenceTest extends TestCase
{
    /**
     * @var int[]
     */
    ...
    /**
     * @var \Smpl\Collections\Tests\Fixtures\DecoratedSequence 
     */
    private DecoratedSequence $sequence;

    public function setUp(): void
    {
        $this->sequence = new DecoratedSequence($this->elements);
    }
    ...
    {
        $sequence = new DecoratedSequence($elements);
    ...
    {
        $sequence = DecoratedSequence::of(...$elements);
    ...
    {
        $sequence = new DecoratedSequence();
    ...
    public function sequenceContainsComparatorProvider(): array
    {
        ...
        $creator               = function (Comparator $comparator): DecoratedSequence {
            return new DecoratedSequence($this->elements, $comparator);
        };
     ...
     */
    public function knowsWhatItContainsWithComparator(int|string $value, bool $result, DecoratedSequence $sequence): void
    {
     ...
     */
    public function knowsWhatItContainsAllWithComparator(array $value, bool $result, DecoratedSequence $sequence): void
    {
     ...
     */
    public function countsMatchingElementsWithComparator(int|string $value, int $result, DecoratedSequence $sequence): void
    {
    ...
    {
        self::assertTrue((new DecoratedSequence())->isEmpty());
    ...
    {
        $sequence = DecoratedSequence::of(1, 2, 3, 4, 1, 1, 5, 7, 9, 10, 15, 3, 15);
     ...
     */
    public function canFindElementsWithAnIndexOffset(DecoratedSequence $sequence, int $element, int $index, ?int $result)
    {
     ...
     */
    public function canFindElementsWithComparatorAndAnIndexOffset(DecoratedSequence $sequence, Comparator $comparator, int $element, int $index, ?int $result)
    {
        $sequence->setComparator($comparator);
        self::assertSame($result, $sequence->find($element, $index));
    }
     ...
     */
    public function throwsOutOfRangeExceptionWhenFindingElementWithIndexOffset(DecoratedSequence $sequence, int $element, int $index)
    {
    ...
    {
        self::assertSame($first, DecoratedSequence::of(...$elements)->first());
    }
    ...
    {
        self::assertSame($result, DecoratedSequence::of(...$elements)->get($index));
    }
     ...
     */
    public function throwsOutOfRangeExceptionWhenGettingElementByIndex(DecoratedSequence $sequence, int $index)
    {
        $this->expectException(OutOfRangeException::class);
        $this->expectExceptionMessage(sprintf(
            'The provided index %s is outside the required range of %s <> %s',
    ...
    {
        self::assertSame($result, DecoratedSequence::of(...$elements)->has($index));
    }
    ...
    {
        self::assertSame($result, DecoratedSequence::of(...$elements)->indexOf($element));
    }
    ...
    {
        self::assertSame($result, DecoratedSequence::of(...$elements)->indexesOf($element)->toArray());
    }
    ...
    {
        self::assertSame($result, DecoratedSequence::of(...$elements)->lastIndexOf($element));
    }
    ...
    {
        self::assertSame($first, DecoratedSequence::of(...$elements)->last());
    }
     ...
     */
    public function throwsOutOfRangeExceptionWhenPuttingElementAtIndex(DecoratedSequence $sequence, int $index, int $element)
    {
        $this->expectException(OutOfRangeException::class);
        $this->expectExceptionMessage(sprintf(
            'The provided index %s is outside the required range of %s <> %s',
     ...
     */
    public function throwsOutOfRangeExceptionWhenPuttingAllElementAtIndex(DecoratedSequence $sequence, int $index, array $elements)
    {
        $this->expectException(OutOfRangeException::class);
        $this->expectExceptionMessage(sprintf(
            'The provided index %s is outside the required range of %s <> %s',
     ...
     */
    public function throwsOutOfRangeExceptionWhenSettingElementAtIndex(DecoratedSequence $sequence, int $index, int $element)
    {
        $this->expectException(OutOfRangeException::class);
        $this->expectExceptionMessage(sprintf(
            'The provided index %s is outside the required range of %s <> %s',
     ...
     */
    public function throwsOutOfRangeExceptionWhenSettingAllElementAtIndex(DecoratedSequence $sequence, int $index, array $elements)
    {
        $this->expectException(OutOfRangeException::class);
        $this->expectExceptionMessage(sprintf(
            'The provided index %s is outside the required range of %s <> %s',
     ...
     * @dataProvider sequenceSetExceptionProvider
     */
    public function throwsOutOfRangeExceptionWhenSettingElementAtIndexAsAnArray(DecoratedSequence $sequence, int $index, int $element)
    {
        $this->expectException(OutOfRangeException::class);
        $this->expectExceptionMessage(sprintf(
            'The provided index %s is outside the required range of %s <> %s',

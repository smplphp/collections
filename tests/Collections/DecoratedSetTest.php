...
use Smpl\Collections\Tests\Fixtures\DecoratedSet;
 ...
 * @group decorated
 */
class DecoratedSetTest extends TestCase
{
    /**
     * @var int[]
     */
    ...
    /**
     * @var \Smpl\Collections\Tests\Fixtures\DecoratedSet
     */
    private DecoratedSet $set;

    public function setUp(): void
    {
        $this->set = new DecoratedSet($this->elements);
    }
    ...
    {
        $collection = new DecoratedSet($elements);
    ...
    {
        $collection = DecoratedSet::of(...$elements);
    ...
    public function setContainsComparatorProvider(): array
    {
        ...
        $creator               = function (Comparator $comparator): DecoratedSet {
            return new DecoratedSet($this->elements, $comparator);
        };
     ...
     */
    public function knowsWhatItContainsWithComparator(int|string $value, bool $result, DecoratedSet $collection): void
    {
     ...
     */
    public function knowsWhatItContainsAllWithComparator(array $value, bool $result, DecoratedSet $collection): void
    {
     ...
     */
    public function countsMatchingElementsWithComparator(int|string $value, int $result, DecoratedSet $collection): void
    {
    ...
    {
        self::assertTrue((new DecoratedSet())->isEmpty());

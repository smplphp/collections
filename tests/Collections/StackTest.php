...
class StackTest extends TestCase
{
    ...
    /**
     * @var \Smpl\Collections\Stack
     */
    private Stack $stack;

    public function setUp(): void
    {
        $this->stack = new Stack($this->elements);
    }
    ...
    public function queueCreatesFromIterables(): array
    {
        return [
            ...
            'From Stack'         => [new Stack([0, 1, 2, 3, 4, 5, 6]), 7],
        ];
    }
    ...
    public function queueContainsComparatorProvider(): array
    {
        ...
        $creator               = function (Comparator $comparator): Stack {
            return new Stack($this->elements, $comparator);
        };
     ...
     */
    public function knowsWhatItContainsWithComparator(int|string $value, bool $result, Stack $collection): void
    {
     ...
     */
    public function knowsWhatItContainsAllWithComparator(array $value, bool $result, Stack $collection): void
    {
     ...
     */
    public function countsMatchingElementsWithComparator(int|string $value, int $result, Stack $collection): void
    {
    ...
    {
        self::assertTrue((new Stack())->isEmpty());

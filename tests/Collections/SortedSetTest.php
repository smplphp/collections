...
class SortedSetTest extends TestCase
{
    ...
    /**
     * @var \Smpl\Collections\SortedSet 
     */
    private SortedSet $set;

    public function setUp(): void
    {
        $this->set = new SortedSet($this->elements);
    }
    ...
    {
        $collection = new SortedSet($elements);
    ...
    {
        $collection = SortedSet::of(...$elements);
    ...
    public function setContainsComparatorProvider(): array
    {
        ...
        $creator               = function (Comparator $comparator): SortedSet {
            return new SortedSet($this->elements, $comparator);
        };
     ...
     */
    public function knowsWhatItContainsWithComparator(int|string $value, bool $result, SortedSet $collection): void
    {
     ...
     */
    public function knowsWhatItContainsAllWithComparator(array $value, bool $result, SortedSet $collection): void
    {
     ...
     */
    public function countsMatchingElementsWithComparator(int|string $value, int $result, SortedSet $collection): void
    {
    ...
    {
        $modifiedCopy = $this->set->copy([1, 2, 3]);
    ...
    {
        self::assertTrue((new SortedSet())->isEmpty());
    ...
    public function addElementProvider(): array
    {
        return [
            ...
            'Add 10 (duplicate)' => [10, false, true, 1],
            'Add 1 (duplicate)'  => [1, false, true, 1],
        ];
    }
    ...
    public function addAllElementProvider(): array
    {
        return [
            ...
            'Add 9, 10, 11 (duplicate, duplicate, new)'     => [[9, 10, 11], true, [true, true, true], [1, 1, 1]],
            'Add 1, 2, 3 (duplicate, duplicate, duplicate)' => [[1, 2, 3], false, [true, true, true], [1, 1, 1]],
        ];
    }
    ...
    public function removeElementProvider(): array
    {
        return [
            ...
            'Remove 10 (exists(3))'                            => [10, true, false, 0, true, 1, [10, 10, 10]],
    ...
    public function removeAllElementProvider(): array
    {
        return [
            ...
            'Remove 1, 2, 3 (exists(3), exists, exists(2))' => [[1, 2, 3], true, 10, 7, [1, 1, 3]],
    ...
    public function retainAllElementProvider(): array
    {
        return [
            ...
            'Retain 1, 2, 3 (exists(3), exists, exists(2))' => [[1, 2, 3], true, 10, 3, [1, 1, 3], [true, true, true], [1, 1, 1]],
    ...
    {
        self::assertSame($result, $this->set->ceiling($element));
    }
    ...
    {
        self::assertSame($result, $this->set->floor($element));
    }
    ...
    {
        if ($inclusive !== null) {
            $headset = $this->set->headset($element, $inclusive);
        } else {
            $headset = $this->set->headset($element);
        }
    ...
    {
        self::assertSame($result, $this->set->higher($element));
    }
    ...
    {
        self::assertSame($result, $this->set->lower($element));
    }
    ...
    public function getAllElementsBetweenTheProvidedProvided(int $fromElement, int $toElement, ?bool $fromInclusive, ?bool $toInclusive, array $result): void
    {
        if ($fromInclusive !== null) {
            if ($toInclusive !== null) {
                $subset = $this->set->subset($fromElement, $toElement, $fromInclusive, $toInclusive);
            } else {
                $subset = $this->set->subset($fromElement, $toElement, $fromInclusive);
            }
        } else if ($toInclusive !== null) {
            $subset = $this->set->subset($fromElement, $toElement, toInclusive: $toInclusive);
        } else {
            $subset = $this->set->subset($fromElement, $toElement);
        }
    ...
    {
        if ($inclusive !== null) {
            $tailset = $this->set->tailset($element, $inclusive);
        } else {
            $tailset = $this->set->tailset($element);
        }

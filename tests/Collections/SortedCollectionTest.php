...
class SortedCollectionTest extends TestCase
{
    ...
    {
        $this->collection = new SortedCollection($this->elements);
    }
    ...
    public function collectionCreatesFromIterables(): array
    {
        return [
            ...
            'From SortedCollection' => [new Collection([6, 5, 4, 3, 2, 1, 0]), 7],
        ];
    }
    ...
    {
        $collection = new SortedCollection($elements);
    ...
    {
        $collection = SortedCollection::of(...$elements);
    ...
    public function collectionContainsComparatorProvider(): array
    {
        ...
        $creator               = function (Comparator $comparator): SortedCollection {
            return new SortedCollection($this->elements, $comparator);
        };
     ...
     */
    public function knowsWhatItContainsWithComparator(int|string $value, bool $result, SortedCollection $collection): void
    {
     ...
     */
    public function knowsWhatItContainsAllWithComparator(array $value, bool $result, SortedCollection $collection): void
    {
     ...
     */
    public function countsMatchingElementsWithComparator(int|string $value, int $result, SortedCollection $collection): void
    {
    ...
    {
        $modifiedCopy = $this->collection->copy([3, 2, 1]);
    ...
    {
        self::assertTrue((new SortedCollection())->isEmpty());
    ...
    {
        self::assertSame($result, $this->collection->ceiling($element));
    }
    ...
    {
        self::assertSame($result, $this->collection->floor($element));
    }
    ...
    {
        if ($inclusive !== null) {
            $headset = $this->collection->headset($element, $inclusive);
        } else {
            $headset = $this->collection->headset($element);
        }
    ...
    {
        self::assertSame($result, $this->collection->higher($element));
    }
    ...
    {
        self::assertSame($result, $this->collection->lower($element));
    }
    ...
    public function getAllElementsBetweenTheProvidedProvided(int $fromElement, int $toElement, ?bool $fromInclusive, ?bool $toInclusive, array $result): void
    {
        if ($fromInclusive !== null) {
            if ($toInclusive !== null) {
                $subset = $this->collection->subset($fromElement, $toElement, $fromInclusive, $toInclusive);
            } else {
                $subset = $this->collection->subset($fromElement, $toElement, $fromInclusive);
            }
        } else if ($toInclusive !== null) {
            $subset = $this->collection->subset($fromElement, $toElement, toInclusive: $toInclusive);
        } else {
            $subset = $this->collection->subset($fromElement, $toElement);
        }
    ...
    {
        if ($inclusive !== null) {
            $tailset = $this->collection->tailset($element, $inclusive);
        } else {
            $tailset = $this->collection->tailset($element);
        }

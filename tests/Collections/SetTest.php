...
class SetTest extends TestCase
{
    ...
    {
        $this->set = new Set($this->elements);
    }
    ...
    public function setContainsComparatorProvider(): array
    {
        ...
        $creator               = function (Comparator $comparator): Set {
     ...
     */
    public function knowsWhatItContainsWithComparator(int|string $value, bool $result, Set $collection): void
    {
     ...
     */
    public function knowsWhatItContainsAllWithComparator(array $value, bool $result, Set $collection): void
    {
     ...
     */
    public function countsMatchingElementsWithComparator(int|string $value, int $result, Set $collection): void
    {

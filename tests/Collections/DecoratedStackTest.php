...
use Smpl\Collections\Tests\Fixtures\DecoratedStack;
 ...
 * @group decorated 
 */
class DecoratedStackTest extends TestCase
{
    /**
     * @var int[]
     */
    ...
    /**
     * @var \Smpl\Collections\Tests\Fixtures\DecoratedStack
     */
    private DecoratedStack $stack;

    public function setUp(): void
    {
        $this->stack = new DecoratedStack($this->elements);
    }
    ...
    public function queueCreatesFromIterables(): array
    {
        return [
            ...
            'From DecoratedStack'         => [new DecoratedStack([0, 1, 2, 3, 4, 5, 6]), 7],
        ];
    }
    ...
    {
        $collection = new DecoratedStack($elements);
    ...
    {
        $collection = DecoratedStack::of(...$elements);
    ...
    {
        self::assertEquals($result, $this->stack->contains($value));
    }
    ...
    public function queueContainsComparatorProvider(): array
    {
        ...
        $creator               = function (Comparator $comparator): DecoratedStack {
            return new DecoratedStack($this->elements, $comparator);
        };
     ...
     */
    public function knowsWhatItContainsWithComparator(int|string $value, bool $result, DecoratedStack $collection): void
    {
    ...
    {
        self::assertEquals($result, $this->stack->containsAll($value));
    }
     ...
     */
    public function knowsWhatItContainsAllWithComparator(array $value, bool $result, DecoratedStack $collection): void
    {
     ...
     */
    public function countsMatchingElementsWithComparator(int|string $value, int $result, DecoratedStack $collection): void
    {
    ...
    {
        $modifiedCopy = $this->stack->copy([1, 2, 3]);

        self::assertSame($this->stack->toArray(), $this->stack->copy()->toArray());
        self::assertSame([1, 2, 3], $modifiedCopy->toArray());
        self::assertNotSame($this->stack->toArray(), $modifiedCopy->toArray());
    }
    ...
    {
        self::assertTrue((new DecoratedStack())->isEmpty());
    ...
    {
        $elements = $this->stack->toArray();

        self::assertSame(count($elements), $this->stack->count());

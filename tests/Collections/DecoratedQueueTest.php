...
use Smpl\Collections\Tests\Fixtures\DecoratedQueue;
 ...
 * @group decorated
 */
class DecoratedQueueTest extends TestCase
{
    /**
     * @var int[]
     */
    ...
    /**
     * @var \Smpl\Collections\Tests\Fixtures\DecoratedQueue
     */
    private DecoratedQueue $queue;

    public function setUp(): void
    {
        $this->queue = new DecoratedQueue($this->elements);
    }
    ...
    public function queueCreatesFromIterables(): array
    {
        return [
            ...
            'From DecoratedQueue' => [new DecoratedQueue([0, 1, 2, 3, 4, 5, 6]), 7],
        ];
    }
    ...
    {
        $collection = new DecoratedQueue($elements);
    ...
    {
        $collection = DecoratedQueue::of(...$elements);
    ...
    public function queueContainsComparatorProvider(): array
    {
        ...
        $creator               = function (Comparator $comparator): DecoratedQueue {
            return new DecoratedQueue($this->elements, $comparator);
        };
     ...
     */
    public function knowsWhatItContainsWithComparator(int|string $value, bool $result, DecoratedQueue $collection): void
    {
     ...
     */
    public function knowsWhatItContainsAllWithComparator(array $value, bool $result, DecoratedQueue $collection): void
    {
     ...
     */
    public function countsMatchingElementsWithComparator(int|string $value, int $result, DecoratedQueue $collection): void
    {
    ...
    {
        self::assertTrue((new DecoratedQueue())->isEmpty());

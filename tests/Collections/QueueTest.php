...
class QueueTest extends TestCase
{
    ...
    /**
     * @var \Smpl\Collections\Queue
     */
    private Queue $queue;

    public function setUp(): void
    {
        $this->queue = new Queue($this->elements);
    }
    ...
    public function queueCreatesFromIterables(): array
    {
        return [
            ...
            'From Queue'         => [new Queue([0, 1, 2, 3, 4, 5, 6]), 7],
        ];
    }
    ...
    public function queueContainsComparatorProvider(): array
    {
        ...
        $creator               = function (Comparator $comparator): Queue {
            return new Queue($this->elements, $comparator);
        };
     ...
     */
    public function knowsWhatItContainsWithComparator(int|string $value, bool $result, Queue $collection): void
    {
     ...
     */
    public function knowsWhatItContainsAllWithComparator(array $value, bool $result, Queue $collection): void
    {
     ...
     */
    public function countsMatchingElementsWithComparator(int|string $value, int $result, Queue $collection): void
    {
    ...
    {
        self::assertTrue((new Queue())->isEmpty());

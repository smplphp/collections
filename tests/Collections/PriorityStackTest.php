...
use Smpl\Collections\Support\PriorityCollectionFlags as PriorityStackContract;
...
class PriorityStackTest extends TestCase
{
    ...
    public function refusesNullForAddWhenSetWithNoNullFlag(): void
    {
        ...
        $queue = $this->queue->copy(flags: PriorityCollectionFlags::NO_NULL);
        $queue->add(null);
    }
    ...
    public function defaultFlagsAreCorrect(): void
    {
        ...
        self::assertSame(($queue->flags() & PriorityCollectionFlags::NO_PRIORITY_LAST), PriorityCollectionFlags::NO_PRIORITY_LAST);
    }
}
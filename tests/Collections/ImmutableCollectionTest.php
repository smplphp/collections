...
class ImmutableCollectionTest extends TestCase
{
     ...
     */
    public function knowsWhatItContainsWithComparator(int|string $value, bool $result, ImmutableCollection $collection): void
    {
     ...
     */
    public function knowsWhatItContainsAllWithComparator(array $value, bool $result, ImmutableCollection $collection): void
    {
     ...
     */
    public function countsMatchingElementsWithComparator(int|string $value, int $result, ImmutableCollection $collection): void
    {

 ...
 * @group decorated
 */
class DecoratedCollectionTest extends TestCase
{
    /**
     * @var int[]
     */
    ...
    /**
     * @var \Smpl\Collections\Tests\Fixtures\DecoratedCollection
     */
    private DecoratedCollection $collection;

    public function setUp(): void
    {
        $this->collection = new DecoratedCollection($this->elements);
    }
    ...
    {
        $collection = new DecoratedCollection($elements);
    ...
    {
        $collection = DecoratedCollection::of(...$elements);
    ...
    {
        $collection = new DecoratedCollection();
    ...
    public function collectionContainsComparatorProvider(): array
    {
        ...
        $creator               = function (Comparator $comparator): DecoratedCollection {
            return new DecoratedCollection($this->elements, $comparator);
        };
     ...
     */
    public function knowsWhatItContainsWithComparator(int|string $value, bool $result, DecoratedCollection $collection): void
    {
     ...
     */
    public function knowsWhatItContainsAllWithComparator(array $value, bool $result, DecoratedCollection $collection): void
    {
     ...
     */
    public function countsMatchingElementsWithComparator(int|string $value, int $result, DecoratedCollection $collection): void
    {
    ...
    {
        self::assertTrue((new DecoratedCollection())->isEmpty());
    ...
    public function proxiesComparesValuesMethods(): void
    {
        ...
        self::assertSame($collection, $collection->setComparator($comparator));

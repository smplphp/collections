...
use Smpl\Collections\Tests\Fixtures\DecoratedImmutableCollection;
 ...
 * @group decorated
 */
class DecoratedImmutableCollectionTest extends TestCase
{
    /**
     * @var int[]
     */
    ...
    /**
     * @var \Smpl\Collections\Tests\Fixtures\DecoratedImmutableCollection
     */
    private DecoratedImmutableCollection $collection;

    public function setUp(): void
    {
        $this->collection = new DecoratedImmutableCollection($this->elements);
    }
    ...
    public function collectionCreatesFromIterables(): array
    {
        return [
            ...
            'From DecoratedImmutableCollection' => [new DecoratedImmutableCollection([0, 1, 2, 3, 4, 5, 6]), 7],
        ];
    }
    ...
    {
        $collection = new DecoratedImmutableCollection($elements);
    ...
    {
        $collection = DecoratedImmutableCollection::of(...$elements);
    ...
    {
        $collection = new DecoratedImmutableCollection();
    ...
    public function collectionContainsComparatorProvider(): array
    {
        ...
        $creator               = function (Comparator $comparator): DecoratedImmutableCollection {
            return new DecoratedImmutableCollection($this->elements, $comparator);
        };
    ...
    {
        self::assertTrue((new DecoratedImmutableCollection())->isEmpty());
    ...
    public function storesComparator(): void
    {
        ...
        $collection = new DecoratedImmutableCollection([], $comparator);

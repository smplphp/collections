 ...
 */
interface PriorityStack extends Stack
{
    /**
     * Prioritise the stack in ascending order.
     */
    public const ASC_ORDER = 1;

    /**
     * Prioritise the stack in descending order.
     */
    public const DESC_ORDER = 2;

    /**
     * Prioritise the stack with null values first.
     */
    public const NULL_VALUE_FIRST = 4;

    /**
     * Prioritise the stack with null values last.
     */
